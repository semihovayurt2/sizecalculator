...
export function TopologyDiagram() {
  ...
  return (
    <div className="rounded-3xl border border-white/10 bg-[#111111]/80 p-6 shadow-[0_20px_60px_rgba(0,0,0,0.25)]">
      <div className="mb-6">
        <p className="text-sm uppercase tracking-[0.3em] text-blue-200/40">Sistem Topolojisi</p>
        <h2 className="mt-3 text-2xl font-semibold text-blue-200/90">Bağlantı Akışı</h2>
      </div>
      <div className="grid gap-5">
        {topology.map((step, index) => (
          <div key={step} className="flex items-center gap-4 rounded-3xl border border-white/10 bg-[#0D0D0D]/95 p-4">
            ...
            <div>
              <p className="text-sm uppercase tracking-[0.24em] text-blue-200/40">{step}</p>
